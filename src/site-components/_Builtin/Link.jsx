...
const Link = React.forwardRef(function Link({ options = { href: '#' }, className = '', button = false, children, block = '', ...props }, ref) {
    ...
    if (UserLink) {
        return (React.createElement(UserLink, { className: className, ...options, ...props, ref: ref }, children));
    }
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("a", { href: href, target: target, className: className, ...props, ref: ref }, children),
