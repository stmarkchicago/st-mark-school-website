...
const MapWidget = React.forwardRef(function MapWidget({ apiKey = '', mapStyle = 'roadmap', zoom = 12, latlng = DEFAULT_LATLNG, tooltip = '', title = '', enableScroll = true, enableTouch = true, className = '', ...props }, ref) {
